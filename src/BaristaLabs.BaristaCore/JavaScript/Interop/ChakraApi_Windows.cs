namespace BaristaLabs.BaristaCore.JavaScript.Interop
{
	...
	internal sealed partial class ChakraApi {
		...
		private class ChakraApi_Windows : IChakraApi, IChakraCommonWindows
		{
			...
			public JsErrorCode JsCopyPropertyIdUtf8(JavaScriptPropertyIdSafeHandle propertyId, byte[] buffer, UIntPtr bufferSize, out UIntPtr length)
			{
			...
			public JsErrorCode JsReleasePropertyId(JavaScriptPropertyIdSafeHandle context, out uint count)
			{
				return NativeMethods.JsReleasePropertyId(context, out count);
			}
			...
			public JsErrorCode JsGetSymbolFromPropertyId(JavaScriptPropertyIdSafeHandle propertyId, out JavaScriptValueSafeHandle symbol)
			{
			...
			public JsErrorCode JsGetPropertyIdFromSymbol(JavaScriptValueSafeHandle symbol, out JavaScriptPropertyIdSafeHandle propertyId)
			{
			...
			public JsErrorCode JsGetProperty(JavaScriptValueSafeHandle @object, JavaScriptPropertyIdSafeHandle propertyId, out JavaScriptValueSafeHandle value)
			{
				return NativeMethods.JsGetProperty(@object, propertyId, out value);
			}
			public JsErrorCode JsGetOwnPropertyDescriptor(JavaScriptValueSafeHandle @object, JavaScriptPropertyIdSafeHandle propertyId, out JavaScriptValueSafeHandle propertyDescriptor)
			{
			...
			public JsErrorCode JsSetProperty(JavaScriptValueSafeHandle @object, JavaScriptPropertyIdSafeHandle propertyId, JavaScriptValueSafeHandle value, bool useStrictRules)
			{
				return NativeMethods.JsSetProperty(@object, propertyId, value, useStrictRules);
			}
			public JsErrorCode JsHasProperty(JavaScriptValueSafeHandle @object, JavaScriptPropertyIdSafeHandle propertyId, out bool hasProperty)
			{
				return NativeMethods.JsHasProperty(@object, propertyId, out hasProperty);
			}
			public JsErrorCode JsDeleteProperty(JavaScriptValueSafeHandle @object, JavaScriptPropertyIdSafeHandle propertyId, bool useStrictRules, out JavaScriptValueSafeHandle result)
			{
				return NativeMethods.JsDeleteProperty(@object, propertyId, useStrictRules, out result);
			}
			public JsErrorCode JsDefineProperty(JavaScriptValueSafeHandle @object, JavaScriptPropertyIdSafeHandle propertyId, JavaScriptValueSafeHandle propertyDescriptor, out bool result)
			{
			...
			public JsErrorCode JsGetPropertyIdFromName(string name, out JavaScriptPropertyIdSafeHandle propertyId)
			{
				return NativeMethods.JsGetPropertyIdFromName(name, out propertyId);
			}
			public JsErrorCode JsGetPropertyNameFromId(JavaScriptPropertyIdSafeHandle propertyId, out string name)
			{
				return NativeMethods.JsGetPropertyNameFromId(propertyId, out name);
			}
			public JsErrorCode JsPointerToString(string stringValue, ulong stringLength, out JavaScriptValueSafeHandle value)
			{
				return NativeMethods.JsPointerToString(stringValue, stringLength, out value);
			}
			public JsErrorCode JsStringToPointer(JavaScriptValueSafeHandle value, out IntPtr stringValue, out ulong stringLength)
			{
			...
			private static class NativeMethods {
				...
				[DllImport(DllName, EntryPoint = "JsRelease" )]
				internal static extern JsErrorCode JsReleasePropertyId(JavaScriptPropertyIdSafeHandle context, out uint count);
				...
				[DllImport(DllName)]
				internal static extern JsErrorCode JsGetProperty(JavaScriptValueSafeHandle @object, JavaScriptPropertyIdSafeHandle propertyId, out JavaScriptValueSafeHandle value);

				[DllImport(DllName)]
				internal static extern JsErrorCode JsGetOwnPropertyDescriptor(JavaScriptValueSafeHandle @object, JavaScriptPropertyIdSafeHandle propertyId, out JavaScriptValueSafeHandle propertyDescriptor);
				...
				[DllImport(DllName)]
				internal static extern JsErrorCode JsSetProperty(JavaScriptValueSafeHandle @object, JavaScriptPropertyIdSafeHandle propertyId, JavaScriptValueSafeHandle value, bool useStrictRules);

				[DllImport(DllName)]
				internal static extern JsErrorCode JsHasProperty(JavaScriptValueSafeHandle @object, JavaScriptPropertyIdSafeHandle propertyId, out bool hasProperty);

				[DllImport(DllName)]
				internal static extern JsErrorCode JsDeleteProperty(JavaScriptValueSafeHandle @object, JavaScriptPropertyIdSafeHandle propertyId, bool useStrictRules, out JavaScriptValueSafeHandle result);

				[DllImport(DllName)]
				internal static extern JsErrorCode JsDefineProperty(JavaScriptValueSafeHandle @object, JavaScriptPropertyIdSafeHandle propertyId, JavaScriptValueSafeHandle propertyDescriptor, out bool result);
				...
				[DllImport(DllName, CharSet = CharSet.Unicode)]
				internal static extern JsErrorCode JsGetPropertyIdFromName(string name, out JavaScriptPropertyIdSafeHandle propertyId);
