namespace BaristaLabs.BaristaCore.JavaScript.Interfaces
{
    ...
    internal interface IChakraCommonWindows
	{
		...
		///     The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
		/// </returns>
		JsErrorCode JsGetPropertyIdFromName(string name, out JavaScriptPropertyId propertyId);
		...
		///     The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
		/// </returns>
		JsErrorCode JsGetPropertyNameFromId(JavaScriptPropertyId propertyId, out string name);
