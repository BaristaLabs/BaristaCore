namespace BaristaLabs.BaristaCore.JavaScript
{
    ...
    /// </returns>
    public delegate bool JavaScriptFetchImportedModuleFromScriptCallback(IntPtr referencingSourceContext, IntPtr specifier, out IntPtr dependentModuleRecord);
}